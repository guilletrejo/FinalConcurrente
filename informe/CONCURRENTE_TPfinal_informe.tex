...
\begin{figure}[H] % Example image
	\centering{\includegraphics[width=1\linewidth]{./figure/test_rdp_ok.png}}
...
%references
\bibitem{ppt_clase} Redes de Petri Temporales - Material de Clase

\bibitem{Libro_Clase}Java 7 Concurrency Cookbook. Javier Fernández González

\bibitem{Paper_Petri} Generación de Código de Sistemas Concurrentes a partir de Redes de Petri Orientadas a Proceso \emph{http://sedici.unlp.edu.ar/bitstream/handle/10915/41771/Documento\_completo.pdf?sequence=1} 
